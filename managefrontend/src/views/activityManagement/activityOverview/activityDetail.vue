  ...
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogVisible" title="是否保存修改" @close="closeDialog" width="30%" center>
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updateActivityDetail">保存</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    updateActivityDetail(){
      axios.get("http://localhost:8888/sys/activity/updateActivity",{
        params:{
          actId:this.actId,
          actName:this.activityDetailForm.activityName,
          actAddress:this.activityDetailForm.address,
          actParticipantNum:this.activityDetailForm.numOfPeople,
          actIntroduction:this.activityDetailForm.introduction,
          actGuideline:this.activityDetailForm.guideline,
          venueId:localStorage.getItem("venueId"),
          actCancelTime:this.activityDetailForm.latestCancelTime,
          actDateString:this.activityDetailForm.date,
          actTime:this.activityDetailForm.time,
          venueVisitScheduleId:this.activityDetailForm.timeSelect,
          actEarliestBookingTimeString:this.activityDetailForm.earliestBookingTime,
          actLatestBookingtimeString:this.activityDetailForm.latestBookingTime,
        }
      }).then(res => {
        console.log(res);
        if(res.data){
