<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogVisible" title="是否确定？" @close="closeDialog" width="30%" center>
...
export default {
  ...
  methods: {
    ...
    updateInfo() {
      // 在这里处理保存信息的逻辑
      this.newBinaryString();
      axios.put("http://localhost:8888/sys/venue/newVenue",{
          ...
          picture: this.venueIntroduction.imageUrl,
        }
      )
      console.log('保存信息');
      // 保存完成后关闭弹窗
